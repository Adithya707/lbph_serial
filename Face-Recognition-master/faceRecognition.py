...
def faceDetection(test_img):             
    ...
    face_haar=cv.CascadeClassifier(r'/home/adihtya/Desktop/Face-Recognition-master/haarcascade_frontalface_alt.xml') #Give path to haar classifier as i have given
